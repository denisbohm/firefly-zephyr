...
bool fd_crypto_aes_decrypt_initialize(void *context __attribute__((unused)), const uint8_t *key, const uint8_t *iv) {
...
bool fd_crypto_aes_decrypt_finalize(void *context __attribute__((unused))) {
    return true;
}
