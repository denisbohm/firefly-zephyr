...
protoc --proto_path=. --proto_path=${proto_path} --nanopb_out=${c_out}/protobuf options.proto
protoc --proto_path=. --proto_path=${proto_path} --nanopb_out=${c_out}/protobuf ${proto_sources}
